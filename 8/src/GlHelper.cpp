...
GlHelper::GlHelper() {
    ...
    std::copy(vertexPositions,vertexPositions + 24*4, this->vertexPositions);
    std::copy(vertexColors,vertexColors + 24*4, this->vertexColors);
    std::copy(vertexIndex,vertexIndex + 36, this->vertexIndex);
